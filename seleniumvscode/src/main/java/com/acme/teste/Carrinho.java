...
public class Carrinho {
	...
	// Realiza a valida��o da mensagem da compra
	...
	public void validarTotal() {
		...
		for (int i = 0; i < listaItens.size(); i++) {
			...
			// Remove moeda e subtitui , por . e remove os espa�os.
			valorItem = Double.parseDouble(valorItemWebElement.getText().replace("R$", "").replace(",", ".").trim());

			// Realiza o c�lculo concatenando os valores a cada la�o de repeti��o
			valorTotal += qtdItem * valorItem;
		}

		// Pega o subtotal e Remove moeda e subtitui , por . e remove os espa�os.
